...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    //попердня товщина детектора - 0.01 cm
    ...
    G4VPhysicalVolume *physDetector = new G4PVPlacement(0,G4ThreeVector(0.,0.,0.01),logicDetector,"physDetector",logicWorld, false, 0, false);
...
// G4Box *solidDetector = new G4Box("solidDetector", 0.005*m, 0.005*m, 0.01*cm);
//     logicDetector = new G4LogicalVolume(solidDetector, C12H18O7, "logicDetector");
